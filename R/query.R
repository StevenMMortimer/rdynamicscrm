...
#' @importFrom XML newXMLNode setXMLNamespace xmlChildren xmlInternalTreeParse xmlAttrs xmlAttrs<- xmlApply xmlToList addChildren getNodeSet xmlValue<- saveXML xmlTextNode xmlParse
#' @template fetchxml
