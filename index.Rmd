...
<br>
<img src="man/figures/rdynamicscrm.png" width="120px" align="right" />
...
language. However, most all operations supported by Dynamics CRM can be made available via this package. 
This package makes requests best formatted to match what the API requires as input. 
